...
### Datasets
- [EgoPAT3Dv2](https://arxiv.org/abs/2403.05046) - The EgoPAT3Dv2 dataset includes 12 distinct scenes and more than 5,400 clips. It features data in various modalities, including RGB, depth, IMU, and point clouds. The dataset captures rearrangement tasks performed by different individuals in diverse scenes, recorded using Microsoft Azure Kinect devices mounted overhead. ICRA 2024. [[paper]](https://arxiv.org/abs/2403.05046) [[project page]](https://ai4ce.github.io/EgoPAT3Dv2/)
